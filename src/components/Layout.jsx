...
import { Logo } from '@/components/Fleek'
...
const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'fleek join', href: '/docs/cli/fleek_join' },
      ...
      { title: 'fleek update', href: '/docs/cli/fleek_update' },
      { title: 'fleek info', href: '/docs/cli/fleek_info' },
      { title: 'fleek show', href: '/docs/cli/fleek_show' },
      { title: 'fleek search', href: '/docs/cli/fleek_search' },
